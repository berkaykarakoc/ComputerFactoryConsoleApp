...
public class GoldCableDecorator extends CableDecorator {
	
	public GoldCableDecorator(Computer decoratedComputer) {
	...
	private void add2Price() {
		setCable(Cable.GOLD);
		setTotalPrice(decoratedComputer.getTotalPrice()+500);
	}
